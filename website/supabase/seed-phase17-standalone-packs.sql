...
update packages set
  description = '20 Uttarakhand GK Tests (50 Questions each)' || chr(10) ||
    '14 topic tests: Uttarakhand (Post-Independence), Statehood Movement II, history, geography, forests, demography, polity, economy & budget, agriculture & energy, festivals & folk culture, art & literature, tourism, Uttarakhand current affairs' || chr(10) ||
