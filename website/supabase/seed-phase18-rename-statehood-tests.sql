...
--   Statehood Movement II -> Uttarakhand Polity (Post-2000)

update tests set test_name = 'Uttarakhand (Post-Independence)', updated_at = now()
where id = 'd5169d3e-b814-4696-9059-24eaf75227df';

update tests set test_name = 'Uttarakhand Polity (Post-2000)', updated_at = now()
...
set description = replace(replace(description,
      'Statehood Movement I & II', 'Uttarakhand (Post-Independence), Uttarakhand Polity (Post-2000)'),
      'Uttarakhand (Post-Independence), Statehood Movement II', 'Uttarakhand (Post-Independence), Uttarakhand Polity (Post-2000)'),
    updated_at = now()
